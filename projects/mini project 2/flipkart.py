...
# print(good_looking_first_response.find_all("a", class_="CGtC98")[0].text)
# print(good_looking_first_response.find('a', {'class' : 'CGtC98'}))
...
#             print(review.select('div')[1].text , end='\n')
...
review_text = listToString(all_page_reviews)
